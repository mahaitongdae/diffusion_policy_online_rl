...
if __name__ == "__main__":
    ...
    if args.alg == 'sdac':
        ...
        agent, params = create_diffv4_net(init_network_key, obs_dim, act_dim, hidden_sizes, diffusion_hidden_sizes, mish,
                                          ...
                                          alpha_transformation=args.alpha_transformation,
                                          initial_log_noise_scale=math.log(args.initial_noise_scale))
        algorithm = DPMDV2Current(agent, params, lr=args.lr,
                           alpha_lr=args.alpha_lr,
                           lr_schedule_end=args.lr_schedule_end,
                           lr_schedule_steps=args.lr_schedule_steps,
                           lr_schedule_begin=args.lr_schedule_begin,
        ...
        agent, params = create_diffv4_net(init_network_key, obs_dim, act_dim, hidden_sizes, diffusion_hidden_sizes, mish,
                                          ...
                                          alpha_transformation=args.alpha_transformation,
                                          initial_log_noise_scale=math.log(args.initial_noise_scale))
        algorithm = DPMDV2Fix1(agent, params, lr=args.lr,
                           alpha_lr=args.alpha_lr,
                           lr_schedule_end=args.lr_schedule_end,
                           lr_schedule_steps=args.lr_schedule_steps,
                           lr_schedule_begin=args.lr_schedule_begin,
        ...
        agent, params = create_diffv4_net(init_network_key, obs_dim, act_dim, hidden_sizes, diffusion_hidden_sizes, mish,
                                          ...
                                          alpha_transformation=args.alpha_transformation,
                                          initial_log_noise_scale=math.log(args.initial_noise_scale))
        algorithm = DPMDV2Fix12(agent, params, lr=args.lr,
                           alpha_lr=args.alpha_lr,
                           lr_schedule_end=args.lr_schedule_end,
                           lr_schedule_steps=args.lr_schedule_steps,
                           lr_schedule_begin=args.lr_schedule_begin,
        ...
        agent, params = create_diffv4_net(init_network_key, obs_dim, act_dim, hidden_sizes, diffusion_hidden_sizes, mish,
                                          ...
                                          alpha_transformation=args.alpha_transformation,
                                          initial_log_noise_scale=math.log(args.initial_noise_scale))
        algorithm = DPMDV2Fix123(agent, params, lr=args.lr,
                           alpha_lr=args.alpha_lr,
                           lr_schedule_end=args.lr_schedule_end,
                           lr_schedule_steps=args.lr_schedule_steps,
                           lr_schedule_begin=args.lr_schedule_begin,
        ...
        agent, params = create_diffv4_net(init_network_key, obs_dim, act_dim, hidden_sizes, diffusion_hidden_sizes, mish,
                                          ...
                                          alpha_transformation=args.alpha_transformation,
                                          initial_log_noise_scale=math.log(args.initial_noise_scale))
        algorithm = DPMDV2Fix1234(agent, params, lr=args.lr,
                           alpha_lr=args.alpha_lr,
                           lr_schedule_end=args.lr_schedule_end,
                           lr_schedule_steps=args.lr_schedule_steps,
                           lr_schedule_begin=args.lr_schedule_begin,
        ...
        agent, params = create_diffv4_net(init_network_key, obs_dim, act_dim, hidden_sizes, diffusion_hidden_sizes, mish,
                                          ...
                                          alpha_transformation=args.alpha_transformation,
                                          initial_log_noise_scale=math.log(args.initial_noise_scale))
        algorithm = DPMDV2Fix12345(agent, params, lr=args.lr,
                           alpha_lr=args.alpha_lr,
                           lr_schedule_end=args.lr_schedule_end,
                           lr_schedule_steps=args.lr_schedule_steps,
                           lr_schedule_begin=args.lr_schedule_begin,
